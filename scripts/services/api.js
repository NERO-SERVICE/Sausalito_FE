...
export async function apiRegister({
  ...
  return apiRequest("/auth/register", {
    ...
    body: {
      ...
      terms_agree: Boolean(agreeTerms),
      privacy_collect_agree: Boolean(agreePrivacy),
      age_over_14_agree: Boolean(agreeAgeOver14),
      health_functional_food_notice_agree: Boolean(agreeHealthFunctionalFood),
      sms_marketing_agree: Boolean(agreeSmsMarketing),
      email_marketing_agree: Boolean(agreeEmailMarketing),
    },
    auth: false,
    retryOnAuth: false,
  });
