import{m as y,a as f,s as m,g as l,d as g}from"./footer-D65fayHX.js";import{u as d,r as h,f as v}from"./cart-service-BIgm5nvz.js";import{f as i}from"./store-data-Deux6dsM.js";const L=y({showCart:!1,currentNav:"shop"});f();const e={cart:{items:[],subtotal:0,shipping:0,total:0}},n={cartList:document.getElementById("cartList"),cartSummary:document.getElementById("cartSummary")};async function u(){const r=await m()||l();g(L,{userName:r?.name||null})}function b(){const r=e.cart.items;r.length?n.cartList.innerHTML=r.map(t=>`
