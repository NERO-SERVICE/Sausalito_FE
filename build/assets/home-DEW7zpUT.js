import{m,a as u,f as p,b as v,c as f,s as g,g as $,d as b}from"./footer-CX_4Vxnh.js";import{c as I}from"./cart-service-BJL0NQK-.js";import{r as y,a as H,f as d}from"./store-data-Deux6dsM.js";const L=m({showCart:!0,currentNav:"home"});u();const r={products:[],banners:[],reviews:[],heroIndex:0};let c=null;const s={heroTrack:document.getElementById("homeHeroTrack"),heroDots:document.getElementById("homeHeroDots"),heroPrev:document.getElementById("heroPrev"),heroNext:document.getElementById("heroNext"),bestProductGrid:document.getElementById("bestProductGrid"),bestReviewList:document.getElementById("bestReviewList")};async function P(){const e=await g()||$();let t=0;try{t=await I()}catch{t=0}b(L,{userName:e?.name||e?.email||null,isAdmin:!!(e?.is_staff??e?.isStaff),cartCountValue:t})}function n(e){r.banners.length&&(r.heroIndex=(e+r.banners.length)%r.banners.length,document.querySelectorAll(".home-hero-slide").forEach((t,o)=>t.classList.toggle("active",o===r.heroIndex)),document.querySelectorAll(".home-hero-dot").forEach((t,o)=>t.classList.toggle("active",o===r.heroIndex)))}function a(){r.banners.length&&(c&&clearInterval(c),c=setInterval(()=>n(r.heroIndex+1),4e3))}function B(){if(!r.banners.length){s.heroTrack.innerHTML="",s.heroDots.innerHTML="";return}s.heroTrack.innerHTML=r.banners.map((e,t)=>`
