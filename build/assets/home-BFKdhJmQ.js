import{m as h,a as u,g as p,s as v}from"./footer-45QzvbMW.js";import{f,a as g,b as $}from"./api-0RWHKEw6.js";import{c as b,r as I,f as d}from"./cart-service-BkS5W-VD.js";const y=h({showCart:!0,currentNav:"home"});u();const r={products:[],banners:[],reviews:[],heroIndex:0};let c=null;const s={heroTrack:document.getElementById("homeHeroTrack"),heroDots:document.getElementById("homeHeroDots"),heroPrev:document.getElementById("heroPrev"),heroNext:document.getElementById("heroNext"),bestProductGrid:document.getElementById("bestProductGrid"),bestReviewList:document.getElementById("bestReviewList")};function H(){const e=p();v(y,{userName:e?.name||null,cartCountValue:b()})}function a(e){r.heroIndex=(e+r.banners.length)%r.banners.length,document.querySelectorAll(".home-hero-slide").forEach((t,o)=>t.classList.toggle("active",o===r.heroIndex)),document.querySelectorAll(".home-hero-dot").forEach((t,o)=>t.classList.toggle("active",o===r.heroIndex))}function n(){c&&clearInterval(c),c=setInterval(()=>a(r.heroIndex+1),4e3)}function L(){s.heroTrack.innerHTML=r.banners.map((e,t)=>`
