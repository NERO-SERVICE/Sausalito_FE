import{m as v,g as f,s as $}from"./header-Bv8tAKev.js";import{f as I,a as P,b}from"./api-C4vJdtqo.js";import{c as y,r as u,f as h}from"./cart-service-BM7B5bfh.js";const E=v({showCart:!0,currentNav:"shop"}),o={products:[],banners:[],reviews:[],heroIndex:0};let l=null;const s={heroTrack:document.getElementById("homeHeroTrack"),heroDots:document.getElementById("homeHeroDots"),heroPrev:document.getElementById("heroPrev"),heroNext:document.getElementById("heroNext"),bestProductGrid:document.getElementById("bestProductGrid"),bestReviewList:document.getElementById("bestReviewList"),newProductGrid:document.getElementById("newProductGrid"),timeDealGrid:document.getElementById("timeDealGrid"),instagramGrid:document.getElementById("instagramGrid")};function H(){const e=f();$(E,{userName:e?.name||null,cartCountValue:y()})}function n(e){o.heroIndex=(e+o.banners.length)%o.banners.length,document.querySelectorAll(".home-hero-slide").forEach((t,r)=>t.classList.toggle("active",r===o.heroIndex)),document.querySelectorAll(".home-hero-dot").forEach((t,r)=>t.classList.toggle("active",r===o.heroIndex))}function c(){l&&clearInterval(l),l=setInterval(()=>n(o.heroIndex+1),4e3)}function L(){s.heroTrack.innerHTML=o.banners.map((e,t)=>`
